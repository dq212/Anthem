...
( function () {
	...
	nameSpace.initAnimation = function () {
		...
		TweenMax.fromTo("#hero", 5, {scale:0.8, x:-90, y:-95, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600}, {scale:.65, y:-90, x:-120, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600, ease:Linear.easeNone});
		TweenMax.fromTo("#hero-2", 5, {scale:0.7, x:-90, y:-50, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600 }, {delay:5, scale:0.8, x:-105, y:-55, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600, ease:Linear.easeNone})

		timeline.fromTo("#copy-1", 1, {autoAlpha:0}, {autoAlpha:1, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600, ease:Cubic.easeOut, ease:Linear.easeNone}, "+=0.5")
				.to("#copy-1", 1.2, {autoAlpha:0, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600, ease:Linear.easeIn},"+=3")
				.to("#hero", 1.2, { autoAlpha:0, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600, ease:Linear.easeNone}, "-=1.2")
		
				.fromTo("#copy-2", 1, {autoAlpha:0}, {autoAlpha:1, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600, ease:Linear.easeNone})
