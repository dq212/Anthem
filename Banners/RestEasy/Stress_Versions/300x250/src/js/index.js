...
( function () {
	...
	nameSpace.initAnimation = function () {
		...
		TweenMax.fromTo("#hero", 5, {scale:1, x:-30, y:-25, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600}, {scale:0.9, y:-25, x:-80, z:0.01, force3D:true, rotationZ: 0.01,  ease:Linear.easeNone});
		TweenMax.fromTo("#hero-2", 5, {scale:0.9,x:-10, y:-10, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600 }, {delay:4.5, scale:1, x:-5, y:-25, z:0.01, force3D:true, rotationZ: 0.01,  ease:Linear.easeNone});
