...
( function () {
	...
	nameSpace.initAnimation = function () {
		...
		TweenMax.fromTo("#hero", 5, {scale:.95, x:-0, y:-25, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600}, {scale:1, y:-10, x:-40, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600, ease:Linear.easeNone});
		TweenMax.fromTo("#hero-2", 5, {scale:.9, y:-10, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600 }, {delay:5, scale:1, x:-10, y:-25, z:0.01, force3D:true, rotationZ: 0.01, transformPerspective: 600, ease:Linear.easeNone})
